...
use crate::encoders::{
    domain::DomainEnc, lifted::ty_constructor::TyConstructorEnc, most_generic_ty::MostGenericTy, predicate::PredicateEnc, GenericEnc
};
    ...
    fn do_encode_full<'vir>(
        ...
        vir::with_vcx(|vcx| {
            ...
            let make_concrete = vcx.mk_function(
                ...
                vcx.alloc_slice(&[]), // Preconditions not allowed in axioms
