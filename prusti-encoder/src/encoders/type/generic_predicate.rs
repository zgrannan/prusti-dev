...
pub struct GenericPredicateEnc;
...
#[derive(Clone, Debug)]
pub struct GenericPredicateEncOutputRef<'vir> {
...
impl<'vir> task_encoder::OutputRefAny for GenericPredicateEncOutputRef<'vir> {}

impl<'vir> GenericPredicateEncOutputRef<'vir> {
...
impl TaskEncoder for GenericPredicateEnc {
    task_encoder::encoder_cache!(GenericPredicateEnc);

    type TaskDescription<'vir> = MostGenericTy<'vir>;

    type OutputRef<'vir> = GenericPredicateEncOutputRef<'vir>;
...
impl<'vir, 'tcx> PredicateEncValues<'vir, 'tcx> {
    ...
    ) -> GenericPredicateEncOutputRef<'vir> {
        GenericPredicateEncOutputRef {
