...
/// A set of untyped specifications associated with a struct.
pub type StructSpecification<'tcx> = common::StructSpecification<ExpressionId, LocalDefId, (mir::Local, ty::Ty<'tcx>)>;
