...
pub fn find_trait_method_substs<'tcx>(
    ...
    eprintln!("!!impl method substs {:?} trait_method_substs: {:?}", impl_method_substs, trait_method_substs);
    ...
    assert_eq!(
        trait_method_substs.len(),
        identity_trait_method.len(),
        "impldefid: {:?} impl method substs: {:?}, trait method substs: {:?}",
        impl_method_def_id, impl_method_substs, trait_method_substs
    );
